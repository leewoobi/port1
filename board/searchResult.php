            ...
            <div class="container">
                <div class="listBoard">
                    ...
                    <div class="listSearch">
                        <a class="form-btn black" href="board.php">list view</a>
                    </div>
...
<?php
    ...
    $sql = "SELECT b.boardID, b.title, b.Content, m.youNickName, b.regTime FROM board b JOIN member m ON (m.memberID = b.memberID) ";
